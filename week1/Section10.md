...
> 동적 리스트란? 항목이 추가, 변경, 삭제될 수 있고, 그 변화를 동적으로 반영하는 리스트가 동적 리스트이다.
...
요 id는 아주 유니크해야 하기 때문에 **UUID로 저장**한다. 
...
UIKit에서 tableview를 화면에 띄우기 위해 필요한 코드량보다 훨씬 적은 코드로 구현이 가능하다.


* Text에다가 커서 갖다대고 오른쪽 버튼 누르면 Embed in HStack, VStack, 같은애들이 나온다. 직접 괄호 안에 넣어가며 쓰는 것보다 이런 기능을 이용하는 게 훨씬 빠르고 실수도 없을 것. 
...
<img width="258" alt="shyness" src="https://github.com/user-attachments/assets/1e3d158f-d572-4b4e-b354-ad973d813ac3">
...
* 애니메이션도 넣을 수 있음. withAnimation(앞에 온점 없음) 블록으로 toggle() 코드 감싸주기.
